  ...
  return (
    ...
    ">
      ...
      <div className="flex flex-1 flex-col">
        ...
        redefines your experience  with unbeatable deals, From premier
        selections to incredible savings, we offer unparalled
        value that sets us apart.
        </p>
        <p className="mt-6 lg:max-w-lg info-text">Navigate a realm of pssibilities designed to fullfiil your unique
        desires, surpassing the loftiest expectations, Your journey
        with us iis nothing short of exceptional.
        </p>
